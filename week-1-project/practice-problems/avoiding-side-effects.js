...
try {
  ...
  function replaceItem(arr, index, newItem) {
    const newArray = [...arr];
    newArray[index] = newItem;// write me!
    return newArray;
  }
  ...
  function concatArrays(arr1, arr2) {
   return arr2.concat(arr1);// write me!
  }
  ...
  function mergeArrays(arr1, arr2) {
    let newArray = [...arr1,...arr2]//arr1.concat(arr2);
    
    let unique_array = Array.from(new Set(newArray));
    return unique_array
  }
    // write me!
