...
try {
  ...
  function readFromObject1() {
    ...
    const obj = {
      a: 0,
      getA: function () {return obj.a; },
      sumAB: function (b) {return obj.a + 1; },
    };
  ...
  function readFromObject2() {
    ...
    const obj = {
      word: '',
      getWord: function () { return "the word is " + obj.word; },
      concat: function (secondHalf) {return obj.word.concat(secondHalf); },
    };
  ...
  function readFromObject3() {
    ...
    const obj = {
      ...
      getCopy: function () {return obj.array.slice(); },
    };
  ...
  function writeToObject1() {
    ...
    const obj = {
      ...
      remixString: function (mixer) {this.string = obj.string.split("").join(mixer); }
    }
  ...
  function writeToObject2() {
    ...
    const obj = {
      ...
      mod: 0,
      equals: 0,
      setNumber: function (num) { this.number = num;},
      modulo: function (modder) {
        this.mod = modder;
        this.equals = this.number % this.mod; }
    };
  ...
  function writeToObject3() {
    ...
    const obj = {
      arr: [1, 0],
      merge: function (toMerge) {this.arr = toMerge.concat(this.arr); },
      replace: function (newArr) {this.arr = newArr; },
    };
  ...
  function readAndWrite1() {
    ...
    const obj = {
      arr: [],
      merge: function (toMerge) { this.arr = toMerge.concat(this.arr);},
      replaceAll: function (newEntry) { this.arr = this.arr.map(item => item = newEntry)},
      getRemixed: function (mixer) {return this.arr.join(mixer); },
      getCopy: function () {return this.arr.slice(); }
    };
  ...
  function soMuchLikeTheProject() {
    ...
    const obj = {
      ...
      readEntry: function (key) {return this.entries[key]; },
      updateEntry: function (key, newValue) {
        this.entries[key] = newValue;
        return newValue;
       },
      deleteEntry: function (key) {
        if(delete this.entries[key]) {
          return true;
        }
        return undefined; 
        },
